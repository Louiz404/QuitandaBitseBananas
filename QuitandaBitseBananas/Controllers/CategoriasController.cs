...
namespace QuitandaBitseBananas.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(QuitandaBitseBananasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CriarRapido([FromBody] Categoria categoria)
        {
            ...
            return Json(new { id = categoria.Id, name = categoria.Name });
        }
